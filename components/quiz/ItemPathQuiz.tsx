...
const ItemPathQuiz = ({
    ...
    const textLeft =
        index % 2 === 0 ? screenWidth / 2 + 60 : screenWidth / 2 - 160
    ...
    return (
        <>
            <View style={styles.containerItemPathQuiz}>
                        ...
                        style={[
                            styles.itemPathQuiz,
                            {
                                ...
                                boxShadow:
                                    concluded === false
                                        ? pendent
                                            ? '0px 7px 0px 0px #c4b74fcc'
                                            : '0px 7px 0px 0px #49454F'
                                        : '0px 7px 0px 0px #B9CA95',
                            },
                        ]}
                    >
                        {getIconByName(icon)}
                ...
                <Text style={[styles.textItemQuiz, { left: textLeft }]}>
                    {name}
                </Text>
            </View>
        </>
